    ...
    <main className="min-h-screen bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">WIDDvar – تقنية تحكيم متطورة</h1>
          
          <div className="relative w-full aspect-video mb-8 rounded-xl overflow-hidden">
            <Image 
              src="/images/section/a1.png" 
              alt="WIDDvar Technology" 
              fill 
          ...
          <div className="prose prose-lg prose-invert max-w-none">
            <p className="text-xl leading-relaxed mb-6">
              تقدم تقنية <strong>WIDDvar</strong> نظام تحكيم متطور يعتمد على الذكاء الاصطناعي لتقديم قرارات دقيقة وفورية. 
              مصممة لتعزيز نزاهة المباريات وتقليل الأخطاء البشرية في التحكيم.
            </p>
