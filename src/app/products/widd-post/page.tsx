        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg prose-invert max-w-none">
            <p className="text-xl leading-relaxed mb-6">
              <strong>رؤيا Post</strong> هي منصة متكاملة لتحليل أداء الفرق
              واللاعبين بعد المباريات. تستخدم أحدث تقنيات الذكاء الاصطناعي
              لتوفير رؤى وتحليلات متعمقة للمدربين والمحللين الرياضيين.
            </p>
