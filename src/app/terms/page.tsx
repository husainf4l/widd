          ...
          <div className="max-w-4xl mx-auto bg-[#1A1D2B]/70 rounded-xl p-8 shadow-lg">
            ...
            <div className="space-y-8 text-gray-200 text-right">
              ...
              <section className="space-y-4">
                ...
                <p>
                  يتم توفير المحتوى والخدمات على موقعنا "كما هي" دون أي ضمان من
                  أي نوع، سواء كان صريحًا أو ضمنيًا. لن نكون مسؤولين عن أي خسائر
                  أو أضرار ناتجة عن استخدام الموقع.
                </p>
              </section>
